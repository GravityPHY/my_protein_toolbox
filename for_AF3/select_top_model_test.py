...
parser.add_argument("path_to_unzip", required=True, help="")
path_to_zip = "/projectnb2/docking/imhaoyu/my_protein_toolbox/for_AF3/8WSQ_antibody.zip"
path_to_unzip = "/projectnb2/docking/imhaoyu/my_protein_toolbox/for_AF3/8WSQ_test"
...
pdb_save_path = ""
pdb_io.save(top_model_path.replace(".cif", ".pdb"))
